...
<form method="POST" action="?/perfect">
    ...
    <label>
        ...
        <br />
        <input name={Config.cloudsName} type="range" bind:value={perfection.clouds} min="0" max="4">
    </label>
    <br />
    <label>
        Precipitation Tolerance: {perfection.precipitation}
        <br />
        <input name={Config.precipitationName} type="range" bind:value={perfection.precipitation} min="0" max="4">
    </label>
    <br />
    <label>
        <input name={Config.metricName} type="checkbox" bind:checked={perfection.metric} value="true" on:change={metricify}>
        Metric Units
    </label>
    <br />
    <br />
